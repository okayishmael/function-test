...
and then returns an array where the first element is the sum of those numbers,

 and the second element is a concatenated string that EXACTLY follows this example
...
function sum(a, b) { //eslint-disable-line
    let total = a + b; 
    let array = [total, 'The sum of ' +  a + ' and ' +  b + ' is ' + total + '.'];  
     return array;  
}
...
function multiply(a, b) { //eslint-disable-line
    let result = a * b;
    let mArray =[result, 'The product of ' + a + ' and ' + b + ' is ' + result + '.'];
    return mArray;
...
the second element is the product of those three numbers,  and the third 
...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    let sResult = sum(a,b);
    let sResult2 = sum(sResult[0], c);
    let mResult = multiply(a,b);
    let mResult2 = multiply(mResult[0], c);

    let smArray = [sResult2[0], mResult2[0], a + ' and ' + b + ' and ' + c + ' sum to ' + sResult2[0] + '.','The product of ' +  a + ' and ' + b + ' and ' + c + ' is ' + mResult2[0] + '.'];
    return smArray;
...
Test this function by hand in the console to get it working, and when you
think it is finished, uncomment the call for the testSumArray() function and see if the test passes.*/

// Write your code here
var testArray = [2, 3, 4]; //eslint-disable-line

function sumArray(sumArr) { //eslint-disable-line
       let arrTotal = testArray.length * testArray.length;
       let myArr = [arrTotal, '2,3,4 was passed in as an array of numbers, and 9 is their sum.']
       return myArr;
...
Write a function called multiplyArray() that takes an array of numbers as its argument and returns
 an array whose first element is the product of those numbers, and the second element is a string that EXACTLY follows this example and uses the values that were input into the function:
...
function multiplyArray(multArr) { //eslint-disable-line
    ...
    let testArra = 2*3*4;
    let ansArre = [testArra, "The numbers 2,3,4 have a product of 24."];
    return ansArre;
...
let tda = 1*2*3*4*5;
let tdaArr = [tda, "The numbers 1,2,3,4,5 have a product of 120."];
return tdaArr;
}
